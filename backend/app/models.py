...
# 7. FINANCEIRO PROFISSIONAL (ATUALIZADO)
class Transaction(db.Model):
    ...
    amount = db.Column(db.Float, nullable=False) # Valor total
    cost = db.Column(db.Float, default=0.0)      # Custo (Material/Comissão)
    type = db.Column(db.String(20), nullable=False) # 'income' (Entrada) ou 'expense' (Saída)
    category = db.Column(db.String(50)) # Ex: Tratamento, Aluguel, Luz, Material
